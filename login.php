    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="validation.php" method="post">
          <div class="input-group form-group">
            ...
            <input type="text" name="cardno" class="form-control" placeholder="Enter your Card no">
      ...
      <div class="card-footer">
        <div class="d-flex justify-content-center links ">
          Don't have an account?<a href="register.php" style="text-decoration: none;"><b>REGISTER</b></a>
        </div>
      </div>
    </div>
  </div>
